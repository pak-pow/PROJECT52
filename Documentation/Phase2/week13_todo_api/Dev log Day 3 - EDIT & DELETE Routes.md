...
- Utilized a Python list comprehension (`[todo for todo in todos if todo["id"] != todo_id]`) to rapidly filter the array. It rebuilds the database by keeping every task _except_ the one that matches the target ID, effectively deleting it from memory.
...
![Day3.1](../../../Picture/week13/day3.1.png)

![Day3.2](../../../Picture/week13/day3.2.png)

![Day3.3](../../../Picture/week13/day3.3.png)
